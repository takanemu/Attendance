...
namespace MonoRaspberryPi
{
    ...
    public class Kintone
    {
        ...
        {
            Console.WriteLine("REST(GET)の通信の実施 - start : " + DateTime.Now.ToString("yyyy/MM/dd HH:mm:ss.fff"));
            string resultString = "";
            ...
            Console.WriteLine("REST(GET)の通信の実施 - end : " + DateTime.Now.ToString("yyyy/MM/dd HH:mm:ss.fff"));
            return resultString;
        }
        ...
        {
            Console.WriteLine("レコード情報の取得 - start : " + DateTime.Now.ToString("yyyy/MM/dd HH:mm:ss.fff"));
            ...
            Console.WriteLine("レコード情報の取得 - end : " + DateTime.Now.ToString("yyyy/MM/dd HH:mm:ss.fff"));
            return entity;
        }
